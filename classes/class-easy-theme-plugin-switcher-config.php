 ...
 * @since 1.0.0
 */
class Easy_Theme_Plugin_Switcher_Config {
	...
	public function load_easy_wp_tp_switcher() {
		...
		$html .= '<li data-wrapper="' . esc_html( 'wp-plugin-wrapper' ) . '" data-role="' . esc_html( 'plugins' ) . '" class="asstes-tab active-tab">' . esc_html( 'Plugins', 'easy-wp-tp-switcher' ) . '</li>';

		$html .= '<li data-wrapper="' . esc_html( 'wp-theme-wrapper' ) . '" data-role="' . esc_html( 'themes' ) . '" class="asstes-tab">' . esc_html( 'Themes', 'easy-wp-tp-switcher' ) . '</li>';
		...
		if ( is_array( $installed_plugins ) && ! empty( $installed_plugins ) ) {
			...
			$html .= '<div class="wp-plugin-wrapper active-asset">';
		...
		if ( is_array( $installed_themes ) && ! empty( $installed_themes ) ) {
			...
			$html .= '<div class="wp-theme-wrapper">';
...
new Easy_Theme_Plugin_Switcher_Config();
